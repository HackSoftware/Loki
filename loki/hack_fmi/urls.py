...
from .views import SkillListView, TeamListView, CompetitorListView, register, Login, register_team\
# from .view import get_request
...
urlpatterns = [
    ...
    # url(r'^api/me/$', get_request, name='me')
]

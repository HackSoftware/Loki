...
from .views import SkillListView, TeamListView, CompetitorListView, Login, register_team, me, CustomRegistrationView
...
urlpatterns = [
    ...
    url(r'^api/register/$', CustomRegistrationView.as_view(), name='register'),

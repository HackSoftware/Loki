...
from .views import SkillListView, TeamListView, CompetitorListView, register, Login, register_team, me, activation
urlpatterns = [
    ...
    url(r'^api/activation', activation, name='activation')
]
